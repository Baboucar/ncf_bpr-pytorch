...
parser.add_argument("--embedding_dim_MLP", type=int, default=64, help="dimension of embedding in MLP submodel")
parser.add_argument("--hidden_layer_MLP", type=list, default=[64, 32, 16], help="hidden layers in MLP")
...
if __name__ == "__main__":
    ...
    # change here and and mantaind pretrainded_true
    if args.use_pretrained:
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 2 == 0 and epoch != 0:
            writer.add_scalar("NDCG@NeuMf", NDCG, epoch)
